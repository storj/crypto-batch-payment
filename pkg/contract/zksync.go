...
// Deprecated: Use ZkSyncMetaData.ABI instead.
...
func (_ZkSync *ZkSyncCaller) FirstPriorityRequestId(opts *bind.CallOpts) (uint64, error) {
	var out []interface{}
	err := _ZkSync.contract.Call(opts, &out, "firstPriorityRequestId")
...
func (_ZkSync *ZkSyncSession) FirstPriorityRequestId() (uint64, error) {
	return _ZkSync.Contract.FirstPriorityRequestId(&_ZkSync.CallOpts)
}
...
func (_ZkSync *ZkSyncCaller) StoredBlockHashes(opts *bind.CallOpts, arg0 uint32) ([32]byte, error) {
	var out []interface{}
	err := _ZkSync.contract.Call(opts, &out, "storedBlockHashes", arg0)
...
func (_ZkSync *ZkSyncSession) StoredBlockHashes(arg0 uint32) ([32]byte, error) {
	return _ZkSync.Contract.StoredBlockHashes(&_ZkSync.CallOpts, arg0)
}
...
func (_ZkSync *ZkSyncCaller) TotalBlocksProven(opts *bind.CallOpts) (uint32, error) {
	var out []interface{}
	err := _ZkSync.contract.Call(opts, &out, "totalBlocksProven")
...
func (_ZkSync *ZkSyncSession) TotalBlocksProven() (uint32, error) {
	return _ZkSync.Contract.TotalBlocksProven(&_ZkSync.CallOpts)
}
...
func (_ZkSync *ZkSyncCaller) TotalOpenPriorityRequests(opts *bind.CallOpts) (uint64, error) {
	var out []interface{}
	err := _ZkSync.contract.Call(opts, &out, "totalOpenPriorityRequests")
...
func (_ZkSync *ZkSyncSession) TotalOpenPriorityRequests() (uint64, error) {
	return _ZkSync.Contract.TotalOpenPriorityRequests(&_ZkSync.CallOpts)
}
...
func (_ZkSync *ZkSyncTransactor) CutUpgradeNoticePeriod(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _ZkSync.contract.Transact(opts, "cutUpgradeNoticePeriod")
}
...
func (_ZkSync *ZkSyncSession) CutUpgradeNoticePeriod() (*types.Transaction, error) {
	return _ZkSync.Contract.CutUpgradeNoticePeriod(&_ZkSync.TransactOpts)
}
...
func (_ZkSync *ZkSyncTransactor) PerformExodus(opts *bind.TransactOpts, _storedBlockInfo StorageStoredBlockInfo, _owner common.Address, _accountId uint32, _tokenId uint32, _amount *big.Int, _nftCreatorAccountId uint32, _nftCreatorAddress common.Address, _nftSerialId uint32, _nftContentHash [32]byte, _proof []*big.Int) (*types.Transaction, error) {
	return _ZkSync.contract.Transact(opts, "performExodus", _storedBlockInfo, _owner, _accountId, _tokenId, _amount, _nftCreatorAccountId, _nftCreatorAddress, _nftSerialId, _nftContentHash, _proof)
}
...
func (_ZkSync *ZkSyncSession) PerformExodus(_storedBlockInfo StorageStoredBlockInfo, _owner common.Address, _accountId uint32, _tokenId uint32, _amount *big.Int, _nftCreatorAccountId uint32, _nftCreatorAddress common.Address, _nftSerialId uint32, _nftContentHash [32]byte, _proof []*big.Int) (*types.Transaction, error) {
	return _ZkSync.Contract.PerformExodus(&_ZkSync.TransactOpts, _storedBlockInfo, _owner, _accountId, _tokenId, _amount, _nftCreatorAccountId, _nftCreatorAddress, _nftSerialId, _nftContentHash, _proof)
}
...
type ZkSyncNoticePeriodChangeIterator struct {
	Event *ZkSyncNoticePeriodChange // Event containing the contract specifics and raw log
...
func (it *ZkSyncNoticePeriodChangeIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ZkSyncNoticePeriodChange)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
type ZkSyncNoticePeriodChange struct {
...
func (_ZkSync *ZkSyncFilterer) FilterNoticePeriodChange(opts *bind.FilterOpts) (*ZkSyncNoticePeriodChangeIterator, error) {
	...
	logs, sub, err := _ZkSync.contract.FilterLogs(opts, "NoticePeriodChange")
	if err != nil {
		return nil, err
	}
	return &ZkSyncNoticePeriodChangeIterator{contract: _ZkSync.contract, event: "NoticePeriodChange", logs: logs, sub: sub}, nil
}
...
func (_ZkSync *ZkSyncFilterer) WatchNoticePeriodChange(opts *bind.WatchOpts, sink chan<- *ZkSyncNoticePeriodChange) (event.Subscription, error) {
	...
	logs, sub, err := _ZkSync.contract.WatchLogs(opts, "NoticePeriodChange")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ZkSyncNoticePeriodChange)
				if err := _ZkSync.contract.UnpackLog(event, "NoticePeriodChange", log); err != nil {
					return err
				}
				event.Raw = log
...
type ZkSyncWithdrawalNFTPendingIterator struct {
	Event *ZkSyncWithdrawalNFTPending // Event containing the contract specifics and raw log
...
func (it *ZkSyncWithdrawalNFTPendingIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ZkSyncWithdrawalNFTPending)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
type ZkSyncWithdrawalNFTPending struct {
	TokenId uint32
	Raw     types.Log // Blockchain specific contextual infos
}
...
func (_ZkSync *ZkSyncFilterer) FilterWithdrawalNFTPending(opts *bind.FilterOpts, tokenId []uint32) (*ZkSyncWithdrawalNFTPendingIterator, error) {
	...
	logs, sub, err := _ZkSync.contract.FilterLogs(opts, "WithdrawalNFTPending", tokenIdRule)
	if err != nil {
		return nil, err
	}
	return &ZkSyncWithdrawalNFTPendingIterator{contract: _ZkSync.contract, event: "WithdrawalNFTPending", logs: logs, sub: sub}, nil
}
...
func (_ZkSync *ZkSyncFilterer) WatchWithdrawalNFTPending(opts *bind.WatchOpts, sink chan<- *ZkSyncWithdrawalNFTPending, tokenId []uint32) (event.Subscription, error) {
	...
	logs, sub, err := _ZkSync.contract.WatchLogs(opts, "WithdrawalNFTPending", tokenIdRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ZkSyncWithdrawalNFTPending)
				if err := _ZkSync.contract.UnpackLog(event, "WithdrawalNFTPending", log); err != nil {
					return err
				}
				event.Raw = log
...
type ZkSyncWithdrawalPendingIterator struct {
	Event *ZkSyncWithdrawalPending // Event containing the contract specifics and raw log
...
func (it *ZkSyncWithdrawalPendingIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(ZkSyncWithdrawalPending)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
type ZkSyncWithdrawalPending struct {
	TokenId uint16
	Amount  *big.Int
	Raw     types.Log // Blockchain specific contextual infos
}
...
func (_ZkSync *ZkSyncFilterer) FilterWithdrawalPending(opts *bind.FilterOpts, tokenId []uint16) (*ZkSyncWithdrawalPendingIterator, error) {
	...
	logs, sub, err := _ZkSync.contract.FilterLogs(opts, "WithdrawalPending", tokenIdRule)
	if err != nil {
		return nil, err
	}
	return &ZkSyncWithdrawalPendingIterator{contract: _ZkSync.contract, event: "WithdrawalPending", logs: logs, sub: sub}, nil
}
...
func (_ZkSync *ZkSyncFilterer) WatchWithdrawalPending(opts *bind.WatchOpts, sink chan<- *ZkSyncWithdrawalPending, tokenId []uint16) (event.Subscription, error) {
	...
	logs, sub, err := _ZkSync.contract.WatchLogs(opts, "WithdrawalPending", tokenIdRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ZkSyncWithdrawalPending)
				if err := _ZkSync.contract.UnpackLog(event, "WithdrawalPending", log); err != nil {
					return err
				}
				event.Raw = log
